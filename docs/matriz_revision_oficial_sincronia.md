# Matriz de revisión oficial de sincronía vocal
...
|---|---:|---:|---|---|---|
| `arcoloria` | PASS | 394 | Pendiente | Pendiente | `MANUAL_REVIEW_REQUIRED` |
| `cortamos-y-volvemos` | PASS | 578 | Pendiente | Pendiente | `MANUAL_REVIEW_REQUIRED` |
| `dano` | PASS | 604 | Pendiente | Pendiente | `MANUAL_REVIEW_REQUIRED` |
| `dias-magicos` | PASS | 516 | Pendiente | Pendiente | `MANUAL_REVIEW_REQUIRED` |
| `eclipsis` | PASS | 477 | Pendiente | Pendiente | `MANUAL_REVIEW_REQUIRED` |
| `fango` | PASS | 399 | Pendiente | Pendiente | `MANUAL_REVIEW_REQUIRED` |
| `luma` | PASS | 401 | Pendiente | Pendiente | `MANUAL_REVIEW_REQUIRED` |
| `maraton-de-peliculas` | PASS | 575 | Pendiente | Pendiente | `MANUAL_REVIEW_REQUIRED` |
| `me-voy-a-morir-si-no-me-besas-ahora-mismo` | PASS | 281 | Pendiente | Pendiente | `MANUAL_REVIEW_REQUIRED` |
| `meteora` | PASS | 392 | Pendiente | Pendiente | `MANUAL_REVIEW_REQUIRED` |
| `mi-hogar` | PASS | 274 | Pendiente | Pendiente | `MANUAL_REVIEW_REQUIRED` |
| `nubia` | PASS | 404 | Pendiente | Pendiente | `MANUAL_REVIEW_REQUIRED` |
| `nuestro-amor-no-es-normal` | PASS | 399 | Pendiente | Pendiente | `MANUAL_REVIEW_REQUIRED` |
| `peligrosa` | PASS | 633 | Pendiente | Pendiente | `MANUAL_REVIEW_REQUIRED` |
| `rompecabezas` | PASS | 490 | Pendiente | Pendiente | `MANUAL_REVIEW_REQUIRED` |
| `solare` | PASS | 563 | Pendiente | Pendiente | `MANUAL_REVIEW_REQUIRED` |
| `tristella` | PASS | 440 | Pendiente | Pendiente | `MANUAL_REVIEW_REQUIRED` |
| `tu-dealer-de-nostalgia` | PASS | 482 | Pendiente | Pendiente | `MANUAL_REVIEW_REQUIRED` |
| `un-poco-bien-un-poco-mal` | PASS | 369 | Pendiente | Pendiente | `MANUAL_REVIEW_REQUIRED` |
| `volver-a-vernos` | PASS | 403 | Pendiente | Pendiente | `MANUAL_REVIEW_REQUIRED` |
