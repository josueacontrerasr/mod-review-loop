...
from diagnose_freeplay_capsule_v267 import SONGS, audit_song

EXPECTED_GENERATED = "FNF Mobile V-Slice 0.8.6 V2.6.7 Freeplay capsule + album asset contract"
...
def main() -> int:
    ...
    payload = {
        "scope": "FREEPLAY_CAPSULE_AND_ALBUM_GATE_V267",
    ...
    out = root / "qa-lab" / "rebuild-v267" / "freeplay-capsule-gate-v267.json"
