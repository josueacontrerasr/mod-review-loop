...
def install(args: argparse.Namespace) -> dict[str, Any]:
    ...
    persistent_root = root / "qa-lab" / "rebuild-v273" / "persistent-mods"
    ...
    audit_root = root / "qa-lab" / "rebuild-v273" / "diable-shaders-audit"
    ...
    report = persistent_root / "persistent-lab-mod-v273.json"
