...
def resolve_one(root: Path, song: str, variation: str = "default") -> dict[str, Any]:
    ...
    if chart.get("generatedBy") != "Friday Night Funkin' - 0.8.6; V2.7.3 calibrated vocal onsets, syllable-accurate holds and player lanes d=0..3": errors.append("chart_generatedBy_invalid")
...
def main() -> int:
    ...
    payload = {
        "scope": "PLAYSTATE_VARIATION_RESOLVER_V273",
    ...
    output = root / "qa-lab" / "rebuild-v273" / "playstate-fix" / "playstate-resolver-production-v273.json"
