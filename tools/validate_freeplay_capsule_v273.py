...
from diagnose_freeplay_capsule_v273 import SONGS, audit_song

EXPECTED_GENERATED = "FNF Mobile V-Slice 0.8.6 V2.7.3 Freeplay capsule + album asset contract"
...
def main() -> int:
    ...
    payload = {
        "scope": "FREEPLAY_CAPSULE_AND_ALBUM_GATE_V273",
    ...
    out = root / "qa-lab" / "rebuild-v273" / "freeplay-capsule-gate-v273.json"
