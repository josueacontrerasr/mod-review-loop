...
def main() -> int:
    ...
    persistent_source = root / "qa-lab" / "rebuild-v273" / "persistent-mods" / "normalized" / MOD_ID
    ...
    payload = {
        "scope": "OFFICIAL_ANDROID_MOD_STAGE_V273",
    ...
    output = root / "qa-lab" / "rebuild-v273" / "official-android-stage-v273.json"
