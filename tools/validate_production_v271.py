...
def one(song: str) -> dict[str, Any]:
    ...
    evidence_dir = ROOT / "qa-lab/rebuild-v271/playstate-fix/density-candidates-canonical" / song
    align_path = evidence_dir / "syllable-alignment.json"
    reduction_path = evidence_dir / "density-reduction-report.json"
...
def main() -> int:
    ...
    payload = {
        "scope": "PRODUCTION_VOCAL_DENSITY_AWARE_GATE_V271",
    ...
    output = ROOT / "qa-lab/rebuild-v271/playstate-fix/production-syllable-gate-v271.json"
