...
VERSION = "2.7.3"
GENERATED_BY = "Friday Night Funkin' - 0.8.6; V2.7.3 calibrated vocal onsets, syllable-accurate holds and player lanes d=0..3"
...
config["chart_generation_mode"] = "V273_CALIBRATED_AUDIO_ONSET_VOCAL_ONLY_PLAYER_LANES_0_3"
audio_policy = config.setdefault("audio_policy", {})
audio_policy["chart_generation_mode"] = "V273_CALIBRATED_AUDIO_ONSET_VOCAL_ONLY_PLAYER_LANES_0_3"
...
release_policy["change_summary"] = "V2.7.3 calibrated audio_onset_ms vocal charts; close attacks preserved with free player-lane reassignment; measured holds only; 21 mods"
qa_policy = config.setdefault("qa_policy", {})
qa_policy["playstate_required_chart_generatedBy"] = GENERATED_BY
qa_policy["complete_delivery_zip"] = f"Esperon-Completo-V{VERSION}.zip"
