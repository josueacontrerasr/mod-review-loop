...
def main():
    ...
    out=EVID/'joint-audio-audit-v260.json'; out.write_text(json.dumps({'version':'2.6.0-joint-vocal-rhythm','status':'PASS','songs':len(rows),'difficulties':60,'parallel_workers':8,'rows':rows},ensure_ascii=False,indent=2)+'\n')
