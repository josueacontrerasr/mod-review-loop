...
REQUIRED = [
    ...
    ROOT / "tools/run_native_mobile_smoke_v272.py",
    ROOT / "tools/stage_official_android_mods_v272.py",
    ROOT / "tools/validate_persistent_lab_mod_v272.py",
    ROOT / ".github/workflows/native-android-mobile-smoke-v272.yml",
...
def main() -> int:
    ...
    workflow = (ROOT / ".github/workflows/native-android-mobile-smoke-v272.yml").read_text(encoding="utf-8")
    ...
    checks.update({
        ...
        "persistent_gate": "validate_persistent_lab_mod_v272.py" in workflow,
        "package_start_timeout": "--package-start-timeout-seconds 90" in workflow,
        "ui_dump_implemented": "uiautomator" in (ROOT / "tools/run_native_mobile_smoke_v272.py").read_text(encoding="utf-8"),
        "gfxinfo_implemented": "dumpsys\", \"gfxinfo" in (ROOT / "tools/run_native_mobile_smoke_v272.py").read_text(encoding="utf-8"),
    ...
    out = ROOT / "qa-lab/rebuild-v272/emulator-v273/lab-gate.json"
