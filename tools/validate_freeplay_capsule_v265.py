...
from diagnose_freeplay_capsule_v265 import SONGS, audit_song

EXPECTED_GENERATED = "FNF Mobile V-Slice 0.8.6 V2.6.5 Freeplay capsule + album asset contract"
...
def main() -> int:
    ...
    payload = {
        "scope": "FREEPLAY_CAPSULE_AND_ALBUM_GATE_V265",
    ...
    out = root / "qa-lab" / "rebuild-v265" / "freeplay-capsule-gate-v265.json"
