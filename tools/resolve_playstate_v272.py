...
def resolve_one(root: Path, song: str, variation: str = "default") -> dict[str, Any]:
    ...
    if chart.get("generatedBy") != "Friday Night Funkin' - 0.8.6; V2.7.2 syllable-accurate vocal chart player lanes d=0..3": errors.append("chart_generatedBy_invalid")
...
def main() -> int:
    ...
    payload = {
        "scope": "PLAYSTATE_VARIATION_RESOLVER_V272",
    ...
    output = root / "qa-lab" / "rebuild-v272" / "playstate-fix" / "playstate-resolver-production-v272.json"
