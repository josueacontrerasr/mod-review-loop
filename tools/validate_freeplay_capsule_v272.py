...
from diagnose_freeplay_capsule_v272 import SONGS, audit_song

EXPECTED_GENERATED = "FNF Mobile V-Slice 0.8.6 V2.7.2 Freeplay capsule + album asset contract"
...
def main() -> int:
    ...
    payload = {
        "scope": "FREEPLAY_CAPSULE_AND_ALBUM_GATE_V272",
    ...
    out = root / "qa-lab" / "rebuild-v272" / "freeplay-capsule-gate-v272.json"
