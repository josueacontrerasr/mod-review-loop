...
from diagnose_freeplay_capsule_v266 import SONGS, audit_song

EXPECTED_GENERATED = "FNF Mobile V-Slice 0.8.6 V2.6.6 Freeplay capsule + album asset contract"
...
def main() -> int:
    ...
    payload = {
        "scope": "FREEPLAY_CAPSULE_AND_ALBUM_GATE_V266",
    ...
    out = root / "qa-lab" / "rebuild-v266" / "freeplay-capsule-gate-v266.json"
