...
import build_syllable_aligned_candidates_v266 as gen

ROOT = Path(__file__).resolve().parents[1]
SRC = ROOT / "qa-lab/rebuild-v263/playstate-fix/syllable-candidates-small"
DEST = ROOT / "qa-lab/rebuild-v266/playstate-fix/syllable-candidates-small"
...
for source_dir in sorted(path for path in SRC.iterdir() if path.is_dir()):
    ...
    report = {
        ...
        "lane_policy": "Player notes use d=0..3; A=0 Left, E=2 Up, I=3 Right, O/U=1 Down; d=0..3 is rejected.",
        "policy": [
...
summary = {
    "scope": "VOCAL_SYLLABLE_ALIGNED_VOWEL_MAPPED_PLAYER_LANE_CANDIDATES_V266",
    "songs": count,
