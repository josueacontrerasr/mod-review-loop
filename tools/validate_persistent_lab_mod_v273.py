...
def main() -> int:
    ...
    report_path = root / "qa-lab/rebuild-v273/persistent-mods/persistent-lab-mod-v273.json"
    ...
    result = {
        "scope": "PERSISTENT_LAB_MOD_GATE_V273",
    ...
    output = root / "qa-lab/rebuild-v273/persistent-mods/persistent-lab-mod-gate-v273.json"
